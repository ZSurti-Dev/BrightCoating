...
emailjs.init("PuHIwuetOAsflFfJx"); // Replace with your actual public key
...
function Contact() {
  ...
  // Handle scrolling to form if hash is present in URL
  useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await emailjs.send(
        'service_4pindc4',    // Replace with your EmailJS service ID
        'template_j2o7qvp',   // Replace with your EmailJS template ID
        {
          name: formData.name,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            <div className="order-1 lg:order-2 space-y-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="min-w-0 flex-1"> 
                      ...
                      <p className="text-gray-600">+91 97227 28688</p>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-gray-600 break-all">brightcoating110@gmail.com</p>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                <div className="p-4 lg:p-6 bg-blue-600">
